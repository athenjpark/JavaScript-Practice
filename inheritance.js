...
class Car {
  ...
  carInfo(){
    return `${this.model}, ${this.year}, ${this.wheels}, ${this.lights}, ${this.signal}, ${this.speed}`
  }
}
...
myToyota.turnOnLights()
myToyota.turnOnSignal()
myToyota.accelerate()
myToyota.decelerate()
...
myVolkswagen.turnOnLights()
myVolkswagen.turnOnSignal()
